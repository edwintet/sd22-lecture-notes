...
// Challenge
/* 
  Utilize a .filter method to create a new array with presdents who were born after the 1900's
...
let presidents1900filter = presidents.filter(
  (presidents) => presidents.year >= 1900
);
...
/* 
 ...
 If forEach is scary, try this with a loop first
 */
presidents1900filter.forEach((president) =>
