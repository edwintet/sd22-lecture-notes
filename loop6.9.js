// Loops
/* 
* Allow us to go over a block of code and determined amount of cycles. It's important to note that it is possible for us to write code without declaring an endpoint.
...
/* 
   Create an arrow function expression called fizzBuzz that takes one parameter. This parameter will be an amount of numbers that a loop within a function will iterate over. In the loop have a condition that checks if:
