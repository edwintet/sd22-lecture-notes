...
console.log(5 < 10 || 7 < 10); // true; one of the sides is true
...
/*
   Syntax: if (conditional){do something}else{...}
   Ternary Syntax: condition ? something if true : something if false 

*/

fName === "Edwin" ? console.log("Student") : console.log("Instructor");
...
let adjustTemperature = (temp) => {
  temperature = temp + 20;
};
adjustTemperature(90); // REASSIGNS GLOBAL VARIANLE'S TEMPRATURE VALUE TO WHATEVER TEMP ARGUMENT IS + 20
...
if (nullCheck === null) {
  console.log("There is a null in there");
} else {
  console.log("The variable has content in it");
}
